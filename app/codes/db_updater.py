    ...
    if data is not None:
        ...
        for index, value in enumerate(data_json):
            for i in value.keys():
                ...
                transfer_tokens_and_update_balances(cur,Configuration.config("STAKE_CT_ADDRESS"),Configuration.config("FOUNDATION_TREASURY_ADDRESS"),NEWRL_TOKEN_CODE,math.ceil(burn_amount))
