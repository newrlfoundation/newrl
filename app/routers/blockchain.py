...
from app.core.consensus.committeemanager import get_committee_for_block, get_committee_for_current_block, get_eligible_miners_with_data, get_score_data
...
def add_token(
    ...
    token_data = {
        ...
        "token_update_type":request.token_update_type,
...
@router.get("/get-commitee-block", tags=[query_tag], include_in_schema=False)
...
def get_miner():
    return get_committee_for_current_block()